...
export const bootstrap = async (config) => {
    ...
    const authService = new AuthService(userService, roleService, clientRepository, sessionRepository, authorizationCodeRepository, consentRepository, refreshTokenRepository, accessTokenRepository, tenantRepository, jwtService);
