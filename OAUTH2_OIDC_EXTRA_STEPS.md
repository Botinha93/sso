...
- [x] Support for response_type=token (implicit, optional)
- [x] Support for nonce (OIDC)
- [x] Support for acr_values, ui_locales, id_token_hint (optional OIDC params)
...
- [x] Support for approval_prompt (legacy, optional)
...
## Discovery & JWKS
- [x] Support for dynamic client registration with tied in app (RFC 7591, optional)

## Logout
- [x] Support for front-channel and back-channel logout (OIDC advanced)
...
## Tests & Docs
- [x] End-to-end (E2E) tests for all flows
